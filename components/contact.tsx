...
const Contact = () => {
  ...
  const GOOGLE_FORM_ACTION_URL =
    "https://docs.google.com/forms/d/e/1FAIpQLSeGkeFurViAKgFZmBiFfbNHZ6HRND1yY6MoaoNI0LidBULkOg/formResponse"
  const ENTRY_NAME = "entry.1234567890"
  const ENTRY_EMAIL = "entry.2345678901"
  const ENTRY_MESSAGE = "entry.3456789012"
