...
export const metadata: Metadata = {
  ...
  description:
    "Milan Sahoo is a Junior Software Developer at Digontom, specializing in Full Stack Development using React, Next.js, Node.js, MongoDB, Flask, AI, IoT, and Robotics. Diploma holder in Computer Science Engineering from Brainware University with real-world project, internship, and research experience.",

  keywords: [
    "Milan Sahoo",
    "Junior Software Developer",
    "Digontom Software Developer",
  ...
  openGraph: {
    title:
      "Milan Sahoo | Junior Software Developer at Digontom | Full Stack Engineer",
    description:
      "Official portfolio of Milan Sahoo – Junior Software Developer at Digontom with expertise in Full Stack Development, AI, IoT, and Robotics.",
  ...
  twitter: {
    ...
    title:
      "Milan Sahoo | Junior Software Developer at Digontom",
    description:
      "Junior Software Developer at Digontom | Full Stack Engineer | React | Next.js | AI | IoT",
